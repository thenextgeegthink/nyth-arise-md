...
const { createGoodbyeCard } = require('../../src/lib/ourin-welcome-card')
const { resolveAnyLidToJid } = require('../../src/lib/ourin-lid')
...
async function sendGoodbyeMessage(sock, groupJid, participant, groupMeta) {
    try {
        ...
        const { cacheParticipantLids, getCachedJid, isLid, isLidConverted, lidToJid } = require('../../src/lib/ourin-lid')
